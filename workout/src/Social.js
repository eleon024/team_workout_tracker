              ...
              <Card.Body>
                ...
                {post.comments && post.comments.length > 0 && (
                  <div style={{ marginTop: '1rem' }}>
                    <h6>Comments:</h6>
                    {post.comments.map((comment, index) => (
                      <Card key={index} style={{ marginBottom: '0.5rem', padding: '0.5rem', display: 'flex', alignItems: 'center' }}>
                        <img
                          src={comment.profilePhotoUrl || '/default-avatar.jpg'}
                          alt="Profile"
                          style={{
                            width: '30px',
                            height: '30px',
                ...
                <Card.Footer style={{ fontSize: '0.8rem', marginTop: '1rem', display: 'flex', alignItems: 'center' }}>
                  <img
                    src={post.profilePhotoUrl || '/default-avatar.jpg'}
                    alt="Profile"
                    style={{
                      width: '40px',
                      height: '40px',
